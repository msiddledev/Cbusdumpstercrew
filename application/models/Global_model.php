...
class Global_model extends CI_Model 
{
	...
	public function records_all($tabel="",$where="",$limit="",$order_col="",$order_by="",$like="",$group_by="",$join_tabel="",$join="",$where_in="",$where_what="")
	{
		$this->db->select('*');
		$this->db->from($tabel);						
		if($where){
		...
		if($where_in)
		{
		    $this->db->where_in($where_what, $where_in);
		}
		if($join){
	...
	public function records_select_all_group_by($select="",$tabel="",$where="",$limit="",$join_tabel="",$join="",$group_by="")
	{
		if($select)
		{
			$this->db->select($select);
		...
		if($join){
			$this->db->join($join_tabel,$join,'inner');		
		}
		if($group_by){
			$this->db->group_by($group_by);
		}
