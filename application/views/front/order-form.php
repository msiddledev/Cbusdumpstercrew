...
<form id="paymentFrm" action="<?php echo base_url('home/payment')?>" method="POST">
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="d-flex mb-4" style="max-width: 300px">
                  ...
                  <div class="form-outline">
                    <input id="productquantity" min="0" name="productquantity" value="0" type="number" class="form-control" />
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <img class="me-2" width="45px"
              ...
              <br/>
              <br/>
              <div id="card-element" style="padding:10px;">
                <form action="<?php echo base_url('home/payments')?>" method="POST" id="paymentFrm">
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                ...
                <input type="text" id="totalprice" name="totalprice" style="border:0px;text-align:right;" class="main-amount pricetotal" value="0" readonly/>
              </li>
            </ul>
...
$(":radio").on("change", function(){
  ...
  var str3 = (210 + total) * $("#productquantity1").val();
  var str =  (180 + total) * $("#productquantity").val();
  var str1 = (210 + total) * $("#productquantity1").val();

  $("#total").text(str2+str3);
  $("#totalprice").val(str+str1+delivery);
});
</script>
