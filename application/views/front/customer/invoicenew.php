            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address"><?php echo $order->address.', '.$order->state.', '.$order->country; ?></div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left"><h3><?php echo $item->product_name; ?></h3>Size : <?php echo get_name_by_id('product_size',$item->size); ?> | Color : <?php echo get_name_by_id('product_color',$item->color); ?> </td>
                ...
                <div class="notices">
                    <div>NOTICE:</div>
                    <div class="notice">© <?php echo date('Y'); ?> <a href="<?php echo base_url();?>">MOYKA</a> All Rights Reserved</div>
                </div>
            </main>
            <footer>
