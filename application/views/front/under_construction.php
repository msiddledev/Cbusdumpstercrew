          ...
          <div class="row pt-5 mt-6">
            <div class="col-md-12 mb-3">
              <div class="intro-info-content text-center">
                <h1 class="display-3 mb-5 wow fadeInDown font-weight-bold" data-wow-delay="0.3s">Website Under Construction
				</h1>
				<hr>
				<h2> Come back soon to check out Columbus's newest crew</h2>
				<h2> THE DUMPSTER CREW</h2> 
              </div>
            </div>
          </div>
        </div>
