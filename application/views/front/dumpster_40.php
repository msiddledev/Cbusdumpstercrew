...
<div class="media mt-5 mr-auto">
		<div class="col-md-5 offset-2 offset-xl-1">
          ...
          <hr>
			...
			provides roll off dumpsters of two sizes. Our larger size is perfect for home construction and renovation, light demolition, and a large amount of concrete and heavy debris. For more information on our 16 yard dumpsters, continue reading below. </p>
          </div>
...
<div class="media mt-5 ml-3">
	<h1 class="text-responsive-h text-center indigo-text offset-xl-1" style="font-family: 'Montserrat', sans-serif; font-weight: 600;"> 16 Yard Dumpsters</h1><hr>
</div>
<div class="row">
	<div class="justify-content-center col-sm-10 offset-md-1" style="margin-bottom: auto">
		<img class="img-fluid rounded offset-md-3" alt="small_dim PLACEHOLDER" src="<?php echo base_url('assets/front/')?>img/large_dumpster_dim.jpg" style="width:50%; height:35%;">
		<h2 style="color: #3F51B5; font-family: 'Montserrat', sans-serif; font-weight: 400;"><b>16 Yard Dumpsters</b></h2>
		<p class="text-responsive text-center" style="font-family: 'Montserrat', sans-serif; font-weight: 300;">Need some serious storage for you waste and debris? Our 16 Yard dumpster has you covered! This size is perfect for concrete and asphalt removal, roofing replacement, or genereal construction. Call us today at the number below or get a free quote online today using the link below and get started on that renovation!
		</p>
		...
		<div class="row" style="justify-content: center">
			...
			<a class="btn btn-indigo btn-lg wow fadeInDown" data-wow-delay="0.3s" href="under_construction.html"><h2 class="d-inline-block" style="color:white"> Rent Online</h2></a>
		</div>
	</div>
</div>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <img
        src="<?php echo base_url('assets/front/')?>img/contruction_2_stock.jpg"
        class="card-img-top"
        alt="..."
      />
      <div class="card-body">
        <h5 class="card-title">House Construction</h5>
        <p class="card-text">
			Our 40 Yard dumpster is a great choice for any large scale building projects, or large scale renovation. This storage solution is built to help the future homeowner manage their waste and keep their site clean.
        </p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img
        src="<?php echo base_url('assets/front/')?>img/roofing_stock.jpg"
        class="card-img-top"
        alt="..."
      />
      <div class="card-body">
        <h5 class="card-title">Roofing Replacement</h5>
        <p class="card-text">
          Our heavy duty 16-Yard dumpster is an accomodating size for a large amount of roofing tiles, for houses small to large. Whether it's rain damaged tiles that need replacing, or just a much needed aesthetic change, our dumpsters have you covered.
        </p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img
        src="<?php echo base_url('assets/front/')?>img/concrete_pour_stock.jpg"
        class="card-img-top"
        alt="..."
      />
      <div class="card-body">
        <h5 class="card-title">Yard and Driveway Renovation</h5>
        <p class="card-text">
			Been having that itch to dig up the old asphalt and redo your enterance, or maybe looking to tear up the patio and put in a new garden? Our largest dumpsters are capabale of hauling loads of asphalt and dirt so it doesn't have to pile up in the yard.
        </p>
      </div>
    </div>
  </div>
