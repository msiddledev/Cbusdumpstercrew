...
if(isset($_POST['save'])){
    $sql = "INSERT INTO orderdelivery (productimage, productname, productprice, productquantity, lengthofrentalperiod, customername, dateofservice, timeofservice, pickupdate, streetaddress, zipcode, phonenumber, emailaddress, total, pricetotal)
    VALUES ('".$_POST["productimage"]."','".$_POST["productname"]."','".$_POST["$productprice"]."'.'".$_POST["productquantity"]."','".$_POST["lengthofrentalperiod"]."','".$_POST["customername"]."'.'".$_POST["dateofservice"]."','".$_POST["timeofservice"]."','".$_POST["pickupdate"]."'.'".$_POST["streetaddress"]."','".$_POST["zipcode"]."','".$_POST["phonenumber"]."'.'".$_POST["emailaddress"]."','".$_POST["$total"]."','".$_POST["$pricetotal"]."')";
    /*$sql = "INSERT INTO orderdelivery (productimage, productname, productprice, productquantity, lengthofrentalperiod, customername, dateofservice, timeofservice, pickupdate, streetaddress, zipcode, phonenumber, emailaddress, total, pricetotal)
    VALUES ('".$_POST["productimage"]."','".$_POST["productname"]."','".$_POST["productprice"]."'.'".$_POST["productquantity"]."','".$_POST["lengthofrentalperiod"]."','".$_POST["customername"]."'.'".$_POST["dateofservice"]."','".$_POST["timeofservice"]."','".$_POST["pickupdate"]."'.'".$_POST["streetaddress"]."','".$_POST["zipcode"]."','".$_POST["phonenumber"]."'.'".$_POST["emailaddress"]."','".$_POST["total"]."','".$_POST["pricetotal"]."')";*/
}
?>
...
<form active="quote_forms.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="d-flex mb-4" style="max-width: 300px">
                  <button class="btn btn-primary px-3 me-2 submit-btn" id="submit"
                    onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                    <i class="fas fa-minus"></i>
                  </button>

                  <div class="form-outline">
                    <input id="productquantity" min="0" name="productquantity" value="0" oninput="calc()" type="number" class="form-control form1s" />
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="d-flex mb-4" style="max-width: 300px">
                  ...
                  <div class="form-outline">
                    <input id="form2" min="0" name="form2" value="0" oninput="calc()" type="number" class="form-control" />
                    <label class="form-label" for="form1">Quantity</label>
                  </div>
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                ...
                <span id="pricetotal" class="pricetotal"><strong>$</strong><strong>0</strong></span>
              </li>
            </ul>
